...
public class ListaChofer extends ActionBarActivity implements AdapterView.OnItemClickListener {
    private String choferes[] = { "Juan Perez", "Pedro Picapiedras", "Ned Flanders", "Leela Duranda",
            "Burguer Burglar", "Meg Griffin", "Alfred"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adaptador = new ArrayAdapter<String>(this,android.R.layout.simple_list_item_1,choferes);
        lstVwChofer.setAdapter(adaptador);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        Toast.makeText(this, "Chofer seleccionado: " + item, Toast.LENGTH_SHORT).show();
        finish();
    }
}
