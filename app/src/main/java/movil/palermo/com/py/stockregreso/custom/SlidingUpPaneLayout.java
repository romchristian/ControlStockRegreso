...
public class SlidingUpPaneLayout extends ViewGroup{
    ...
    private void dimChildView(View v, float mag, int fadeColor) {
        ...
        if (mag > 0 && fadeColor != 0) {
            final int baseAlpha = (fadeColor & 0x00000000) >>> 24;
    ...
    public boolean closePane(View pane, int initialVelocity) {
    ...
    public boolean openPane(View pane, int initialVelocity) {
